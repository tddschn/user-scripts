...
(function() {
    ...
    function removeAds() {
        ...
        const actionButtons = document.querySelectorAll('.TopstoryItem .ContentItem-actions button');
        ...
        actionButtons.forEach(button => {
            ...
            if (button.textContent.includes('举报')) {
                ...
                if (adCard) {
                    ...
                    const title = titleElement ? titleElement.textContent.trim() : 'Ad Article';
