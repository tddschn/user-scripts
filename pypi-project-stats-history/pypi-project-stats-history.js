...
(function() {
    ...
    const sidebar = document.querySelector('.vertical-tabs__tabs .sidebar-section').parentNode;
    if (!sidebar) return;
    ...
    function revealContent() {
        document.getElementById('userscript-pypi-stats-loading').style.display = 'none';
        document.getElementById('userscript-pypi-stats-content').style.display = 'block';
    }
        ...
        onload: function(response) {
            if (response.status === 200) {
                try {
                    ...
                    document.getElementById('stat-day').innerText = formatNumber(data.last_day);
                    document.getElementById('stat-week').innerText = formatNumber(data.last_week);
                    document.getElementById('stat-month').innerText = formatNumber(data.last_month);
                } catch (e) {
