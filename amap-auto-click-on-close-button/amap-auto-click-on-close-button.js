...
(function() {
    ...
    const closeButtonSelector = 'body > div.baxia-dialog.auto > div.baxia-dialog-content > div';

    console.log('[Amap Auto-Closer] Script initialized. Waiting for page to load...');
    ...
    const bodyObserver = new MutationObserver((mutations, obs) => {
        if (document.body) {
            ...
            console.log('[Amap Auto-Closer] Page body found. Checking for initial popup...');
            ...
            console.log('[Amap Auto-Closer] Popup not found yet. Started main observer to wait for it.');
        }
    });
